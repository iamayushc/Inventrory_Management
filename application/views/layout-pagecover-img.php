...
<!-- Mirrored from uselooper.com/layout-pagecover-img.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:59 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Page With Cover Image | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Page With Cover Image">
    ...
    <script type="application/ld+json">
      {
        ...
        "@type": "WebSite",
        "url": "",
        "headline": "Page With Cover Image",
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <header class="page-cover">
              <img class="cover-img" src="assets/images/dummy/cover3.jpg" alt="">
            </header><!-- /.page-cover -->
            <!-- .page-inner -->
              ...
              <header class="page-title-bar">
                ...
                <div class="row align-items-start">
                  ...
                  <div class="col-auto order-lg-first">
                    <!-- .user-avatar -->
                    <a href="user-profile.html" class="user-avatar user-avatar-floated user-avatar-xxl"><img src="assets/images/avatars/uifaces9.jpg" alt=""></a> <!-- /.user-avatar -->
                  </div><!-- /.col-auto -->
                  <!-- .col-auto -->
                  <div class="col col-lg-auto order-lg-last text-right">
                    <button class="btn btn-secondary"><i class="fas fa-user-plus mr-1"></i> Follow</button> <button class="btn btn-secondary"><i class="fas fa-envelope"></i></button>
                  </div><!-- /.col-auto -->
                  <!-- Force next columns to break to new line -->
                  <div class="w-100 d-lg-none"></div><!-- .col -->
                  <div class="col">
                    <h3 class="page-title"> Angela Vargas </h3>
                    <p class="text-muted">
                      <span class="d-inline-block mr-3"><i class="fas fa-map-marker-alt mr-1"></i> <span>Corpus Christi, Texas</span></span> <span class="d-inline-block"><i class="fa fa-globe mr-1"></i> <a href="#">uselooper.com</a></span>
                    </p>
                  </div><!-- /.col -->
                </div><!-- /grid row -->
