...
<!-- Mirrored from uselooper.com/auth-page-message.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:55 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Page Message | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Page Message">
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <div class="page-message" role="alert">
              <i class="fa fa-fw fa-wrench"></i> Scheduled Maintenance Notification: <span class="text-muted-dark">Sunday May 17, 8:00—10:00 AM</span>. <a href="#" class="btn btn-sm btn-warning circle ml-3">Learn More</a> <a href="#" class="btn btn-sm btn-icon btn-warning ml-1" aria-label="Close" onclick="$(this).parent().fadeOut()"><span aria-hidden="true"><i class="fa fa-times"></i></span></a>
            </div><!-- /.page-message -->
            <!-- .page-inner -->
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active">
                      <a href="#"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Auth</a>
                    </li>
                  </ol>
                </nav>
                <h1 class="page-title"> Banner Message </h1>
                <p class="text-muted"> Used to notify the user of a state that affects the entire system. </p>
