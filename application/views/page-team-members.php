...
<!-- Mirrored from uselooper.com/page-team-members.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:43 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Bootstrap Team Members | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Bootstrap Team Members">
    ...
    <script type="application/ld+json">
      {
        ...
        "@type": "WebSite",
        "url": "",
        "headline": "Bootstrap Team Members",
    ...
    <link rel="stylesheet" href="assets/vendor/tributejs/tribute.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
  ...
  <body>
              ...
              <header class="page-title-bar">
                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item active">
                        <a href="page-teams.html"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Teams</a>
                      </li>
                    </ol>
                  </nav><!-- /.breadcrumb -->
                ...
                <div class="nav-scroller border-bottom">
                  ...
                  <div class="nav nav-tabs">
                    <a class="nav-link" href="page-team.html">Overview</a> <a class="nav-link" href="page-team-feeds.html">Feeds</a> <a class="nav-link" href="page-team-projects.html">Projects</a> <a class="nav-link active" href="page-team-members.html">Members</a> <a class="nav-link" href="#">Settings</a>
                  </div><!-- /.nav -->
                </div><!-- /.nav-scroller -->
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row align-items-center">
                        <!-- grid column -->
                        <div class="col-auto">
                          <a href="user-profile.html" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces5.jpg" alt=""> <span class="avatar-badge online" title="online"></span></a>
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col">
                          <h3 class="card-title">
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row align-items-center">
                        <!-- grid column -->
                        <div class="col-auto">
                          <a href="user-profile.html" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces9.jpg" alt=""> <span class="avatar-badge idle" title="idle"></span></a>
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col">
                          <h3 class="card-title">
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row align-items-center">
                        <!-- grid column -->
                        <div class="col-auto">
                          <a href="user-profile.html" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces4.jpg" alt=""> <span class="avatar-badge online" title="online"></span></a>
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col">
                          <h3 class="card-title">
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row align-items-center">
                        <!-- grid column -->
                        <div class="col-auto">
                          <a href="user-profile.html" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces6.jpg" alt=""> <span class="avatar-badge busy" title="busy"></span></a>
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col">
                          <h3 class="card-title">
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row align-items-center">
                        <!-- grid column -->
                        <div class="col-auto">
                          <a href="user-profile.html" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces8.jpg" alt=""> <span class="avatar-badge idle" title="idle"></span></a>
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col">
                          <h3 class="card-title">
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row align-items-center">
                        <!-- grid column -->
                        <div class="col-auto">
                          <a href="user-profile.html" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces7.jpg" alt=""> <span class="avatar-badge online" title="online"></span></a>
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col">
                          <h3 class="card-title">
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row align-items-center">
                        <!-- grid column -->
                        <div class="col-auto">
                          <a href="user-profile.html" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces10.jpg" alt=""> <span class="avatar-badge offline" title="offline"></span></a>
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col">
                          <h3 class="card-title">
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row align-items-center">
                        <!-- grid column -->
                        <div class="col-auto">
                          <a href="user-profile.html" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces11.jpg" alt=""> <span class="avatar-badge online" title="online"></span></a>
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col">
                          <h3 class="card-title">
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row align-items-center">
                        <!-- grid column -->
                        <div class="col-auto">
                          <a href="user-profile.html" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces12.jpg" alt=""> <span class="avatar-badge online" title="online"></span></a>
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col">
                          <h3 class="card-title">
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row align-items-center">
                        <!-- grid column -->
                        <div class="col-auto">
                          <a href="user-profile.html" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces13.jpg" alt=""> <span class="avatar-badge busy" title="busy"></span></a>
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col">
                          <h3 class="card-title">
    ...
    <script src="assets/vendor/tributejs/tribute.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
