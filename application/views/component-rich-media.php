...
<!-- Mirrored from uselooper.com/component-rich-media.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:11 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Media Rich | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Media Rich">
    ...
    <link rel="stylesheet" href="assets/vendor/plyr/plyr.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
  ...
  <body>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Rich Media </h1>
                <p class="text-muted"> Create amazing media rich boxes with unlimited style options. </p>
              ...
              <div class="page-section">
                ...
                <div class="card-deck-xl">
                  ...
                  <div class="card card-fluid">
                    <!-- .card-body -->
                    <div class="card-body">
                      <h5 class="card-title"> User Avatar </h5><a href="#" class="btn-account" role="button"><span class="user-avatar user-avatar-md"><img src="assets/images/avatars/profile.jpg" alt=""></span> <span class="account-summary"><span class="account-name">Beni Arisandi</span> <span class="account-description">Administrator</span></span></a>
                      <hr>
                      <h5 class="card-title"> Sizing </h5>
                      <figure class="user-avatar user-avatar-xxl">
                        <img src="assets/images/avatars/profile.jpg" alt="">
                      </figure>
                      <figure class="user-avatar user-avatar-xl">
                        <img src="assets/images/avatars/profile.jpg" alt="">
                      </figure>
                      ...
                      <div class="avatar-group">
                        <figure class="user-avatar">
                          <img src="assets/images/avatars/uifaces4.jpg" alt="">
                        </figure>
                        <figure class="user-avatar">
                      ...
                      <hr>
                      <h5 class="card-title"> With badge </h5>
                      <figure class="user-avatar">
                        <img src="assets/images/avatars/uifaces4.jpg" alt=""> <span class="avatar-badge online"></span>
                      </figure>
                      <figure class="user-avatar">
                        <img src="assets/images/avatars/uifaces5.jpg" alt=""> <span class="avatar-badge idle"></span>
                      </figure>
                      <figure class="user-avatar">
                        <img src="assets/images/avatars/uifaces6.jpg" alt=""> <span class="avatar-badge busy"></span>
                      </figure>
                      <figure class="user-avatar">
                        <img src="assets/images/avatars/uifaces7.jpg" alt=""> <span class="avatar-badge offline"></span>
                      </figure>
                    </div><!-- /.card-body -->
                  </div><!-- /.card -->
                  <!-- .card -->
                  <div class="card card-fluid">
                    <!-- .card-body -->
                    <div class="card-body">
                      <h5 class="card-title"> Badge indicator </h5>
                      <figure class="user-avatar user-avatar-lg">
                        <img src="assets/images/avatars/uifaces4.jpg" alt=""> <span class="avatar-badge has-indicator online"><i class="fa fa-check"></i></span>
                      </figure>
                      <figure class="user-avatar user-avatar-lg">
                        <img src="assets/images/avatars/uifaces5.jpg" alt=""> <span class="avatar-badge has-indicator idle"><i class="fa fa-minus"></i></span>
                      </figure>
                      <figure class="user-avatar user-avatar-lg">
                        <img src="assets/images/avatars/uifaces6.jpg" alt=""> <span class="avatar-badge has-indicator busy"><i class="fa fa-times"></i></span>
                      </figure>
                      <figure class="user-avatar user-avatar-lg">
                        <img src="assets/images/avatars/uifaces7.jpg" alt=""> <span class="avatar-badge has-indicator offline"></span>
                      </figure>
                      <hr>
                      <h5 class="card-title"> Anchor </h5><a href="#" class="user-avatar"><img src="assets/images/avatars/uifaces4.jpg" alt=""> <span class="avatar-badge online"></span></a> <a href="#" class="user-avatar"><img src="assets/images/avatars/uifaces5.jpg" alt=""> <span class="avatar-badge idle"></span></a> <a href="#" class="user-avatar"><img src="assets/images/avatars/uifaces6.jpg" alt=""> <span class="avatar-badge busy"></span></a> <a href="#" class="user-avatar"><img src="assets/images/avatars/uifaces7.jpg" alt=""> <span class="avatar-badge offline"></span></a>
                      <hr>
                      <h5 class="card-title"> Anchor group </h5>
                      <div class="avatar-group">
                        <a href="#" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces4.jpg" alt=""></a> <a href="#" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces5.jpg" alt=""></a> <a href="#" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces6.jpg" alt=""></a> <a href="#" class="user-avatar user-avatar-lg"><img src="assets/images/avatars/uifaces7.jpg" alt=""></a>
                      </div>
                      <hr>
                      <h5 class="card-title"> Dropdowns </h5>
                      <figure class="user-avatar user-avatar-lg dropdown">
                        <a href="#" data-toggle="dropdown"><img src="assets/images/avatars/uifaces4.jpg" alt=""> <span class="avatar-badge has-indicator online"><i class="fa fa-check"></i></span></a>
                        <div class="dropdown-menu">
                          <a href="#" class="dropdown-item">Online</a> <a href="#" class="dropdown-item">Warning</a> <a href="#" class="dropdown-item">Busy</a> <a href="#" class="dropdown-item">Offline</a>
                        </div>
                      </figure>
                      <figure class="user-avatar user-avatar-lg dropdown">
                        <a href="#" data-toggle="dropdown"><img src="assets/images/avatars/uifaces5.jpg" alt=""> <span class="avatar-badge has-indicator idle"><i class="fa fa-minus"></i></span></a>
                        <div class="dropdown-menu">
                          <a href="#" class="dropdown-item">Online</a> <a href="#" class="dropdown-item">Warning</a> <a href="#" class="dropdown-item">Busy</a> <a href="#" class="dropdown-item">Offline</a>
                        </div>
                      </figure>
                      <figure class="user-avatar user-avatar-lg dropdown">
                        <a href="#" data-toggle="dropdown"><img src="assets/images/avatars/uifaces6.jpg" alt=""> <span class="avatar-badge has-indicator busy"><i class="fa fa-times"></i></span></a>
                        <div class="dropdown-menu">
                          <a href="#" class="dropdown-item">Online</a> <a href="#" class="dropdown-item">Warning</a> <a href="#" class="dropdown-item">Busy</a> <a href="#" class="dropdown-item">Offline</a>
                        </div>
                      </figure>
                      <figure class="user-avatar user-avatar-lg dropdown">
                        <a href="#" data-toggle="dropdown"><img src="assets/images/avatars/uifaces7.jpg" alt=""> <span class="avatar-badge has-indicator offline"><i class="fa fa-media-record"></i></span></a>
                        <div class="dropdown-menu">
                          <a href="#" class="dropdown-item">Online</a> <a href="#" class="dropdown-item">Warning</a> <a href="#" class="dropdown-item">Busy</a> <a href="#" class="dropdown-item">Offline</a>
                        </div>
                      </figure>
                ...
                <div class="masonry-layout">
                  ...
                  <div class="masonry-item col-lg-6">
                    <!-- .card -->
                    <div class="card card-fluid">
                      <img src="assets/images/dummy/img-8.jpg" alt="" class="card-img-top img-fluid"> <!-- .card-body -->
                      <div class="card-body pt-2">
                        ...
                        <div class="row align-items-center mb-3">
                          ...
                          <div class="col-auto">
                            <!-- .user-avatar -->
                            <a href="user-profile.html" class="user-avatar user-avatar-floated user-avatar-xl"><img src="assets/images/avatars/uifaces6.jpg" alt=""></a> <!-- /.user-avatar -->
                          </div><!-- /grid column -->
                          <!-- grid column -->
                          <!-- .col -->
                          <div class="col">
                            <h3 class="card-title">
                              <a href="user-profile.html">Jonathan Stewart</a>
                            </h3>
                          ...
                          <!-- grid column -->
                          <div class="col-auto">
                            <button class="btn btn-secondary"><i class="fas fa-user-plus"></i> Follow</button>
                          </div><!-- /grid column -->
                        </div><!-- /grid row -->
                        <!-- grid row -->
                  ...
                  <div class="masonry-item col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div class="card-body text-center">
                        ...
                        <div class="mb-3">
                          <!-- .user-avatar -->
                          <a href="user-profile.html" class="user-avatar user-avatar-floated user-avatar-xl align-baseline"><img src="assets/images/avatars/uifaces5.jpg" alt=""></a> <!-- /.user-avatar -->
                          <h3 class="card-title mt-2">
                            <a href="user-profile.html">Johnny Mitchell</a>
                          </h3>
                          <h6 class="card-subtitle text-muted"> Copywriter </h6>
                        </div><!-- /.mb-3 -->
                        <!-- grid row -->
                        <div class="row">
                          <!-- grid column -->
                  ...
                  <div class="masonry-item col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div class="card-body text-center">
                        <!-- .user-avatar -->
                        <a href="user-profile.html" class="user-avatar user-avatar-xxl my-3"><img src="assets/images/avatars/uifaces16.jpg" alt=""></a> <!-- /.user-avatar -->
                        <h3 class="card-title text-truncate">
                          <a href="user-profile.html">Samantha Gonzales</a>
                        </h3>
                        <h6 class="card-subtitle text-muted mb-3"> Product Designer @CreativeDivision </h6><!-- .skills -->
                        <p class="skills">
                          <a href="#" class="btn btn-xs btn-outline-secondary circle mt-1">react</a> <a href="#" class="btn btn-xs btn-outline-secondary circle mt-1">angular</a> <a href="#" class="btn btn-xs btn-outline-secondary circle mt-1">vue</a> <a href="#" class="btn btn-xs btn-outline-secondary circle mt-1">html5</a> <a href="#" class="btn btn-xs btn-outline-secondary circle mt-1">css3</a> <a href="#" class="btn btn-xs btn-warning circle mt-1">3+</a>
                        </p><!-- /.skills -->
                        ...
                        <p>
                          <a href="#" class="btn btn-primary circle">View Profile <i class="fa fa-arrow-right ml-2"></i></a>
                        </p>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /.masonry-item -->
                  ...
                  <div class="masonry-item col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div class="card-body text-center">
                        <!-- .user-avatar -->
                        <a href="user-profile.html" class="user-avatar user-avatar-xl my-3"><img src="assets/images/avatars/uifaces4.jpg" alt=""></a> <!-- /.user-avatar -->
                        <h3 class="card-title text-truncate">
                          <a href="user-profile.html">Sara Hayes</a>
                        </h3>
                    ...
                    <div class="card card-fluid">
                      ...
                      <div class="card-body">
                        ...
                        <div class="media align-items-center">
                          ...
                          <div class="col-auto">
                            <!-- .user-avatar -->
                            <a href="user-profile.html" class="user-avatar user-avatar-xl"><img src="assets/images/avatars/profile.jpg" alt=""></a> <!-- /.user-avatar -->
                          </div><!-- /grid column -->
                          <!-- grid column -->
                          <div class="col">
                            <h3 class="card-title text-truncate">
                          ...
                          <!-- grid column -->
                          <div class="col-auto">
                            <button type="button" class="btn btn-icon btn-secondary mr-1" data-toggle="tooltip" title="Private message"><i class="far fa-comment-alt"></i></button> <!-- .dropdown -->
                ...
                <div class="section-block">
                  ...
                  <p class="text-muted"> Easily display grids of images, videos, text, and more. </p>
                </div><!-- /.section-block -->
                <!-- grid row -->
                <div class="row">
                  <!-- grid column -->
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="card card-figure">
                      <!-- .card-figure -->
                      <figure class="figure">
                        <img class="img-fluid" src="assets/images/dummy/img-1.jpg" alt="Card image cap"> <!-- .figure-caption -->
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="card card-figure is-hoverable">
                      <!-- .card-figure -->
                      <figure class="figure">
                        <img class="img-fluid" src="assets/images/dummy/img-2.jpg" alt="Card image cap"> <!-- .figure-caption -->
                        <figcaption class="figure-caption">
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="card card-figure">
                      <!-- .card-figure -->
                      <figure class="figure">
                        <img class="img-fluid" src="assets/images/dummy/img-3.jpg" alt="Card image cap"> <!-- .figure-caption -->
                        <figcaption class="figure-caption">
                          <h6 class="figure-title">
                            <a href="#">Clickable title</a>
                          </h6>
                    ...
                    <div class="card card-figure">
                      ...
                      <figure class="figure">
                        ...
                        <div class="figure-img">
                          <img class="img-fluid" src="assets/images/dummy/img-4.jpg" alt="Card image cap"> <a href="#" class="img-link">
                      ...
                      <figure class="figure">
                        ...
                        <div class="figure-img">
                          ...
                          <div class="figure-tools">
                            <a href="#" class="tile tile-circle tile-sm mr-auto"><span class="oi oi-data-transfer-download"></span></a> <span class="badge badge-danger">Illustration</span>
                          </div>
                          <div class="figure-action">
                            <a href="#" class="btn btn-block btn-sm btn-primary">Quick Action</a>
                          </div>
                    ...
                    <div class="card card-figure">
                      ...
                      <figure class="figure">
                        ...
                        <div class="figure-img">
                          ...
                          <div class="figure-tools">
                            <a href="#" class="tile tile-circle tile-sm mr-auto"><span class="oi oi-data-transfer-download"></span></a> <span class="badge badge-danger">Social</span>
                          </div>
                          <div class="figure-action">
                            <a href="#" class="btn btn-block btn-sm btn-primary">Quick Action</a>
                          </div>
                    ...
                    <div class="card card-figure">
                      ...
                      <figure class="figure">
                        ...
                        <div class="figure-attachment">
                          <span class="fa-stack fa-lg"><i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-file-pdf fa-stack-1x fa-inverse"></i></span>
                        </div><!-- /.figure-img -->
                        <figcaption class="figure-caption">
                          <ul class="list-inline d-flex text-muted mb-0">
                            <li class="list-inline-item text-truncate mr-auto">
                              <span class="fa fa-file-pdf-o"></span> Attachment.pdf </li>
                            <li class="list-inline-item">
                              <button type="button" class="btn btn-reset text-muted" title="Download"><span class="oi oi-data-transfer-download"></span></button>
                            </li>
                            <li class="list-inline-item">
                              <button type="button" class="btn btn-reset text-muted" title="More actions"><span class="oi oi-caret-bottom"></span></button>
                            </li>
                          </ul>
                        </figcaption>
                      </figure><!-- /.card-figure -->
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="card card-figure">
                      ...
                      <figure class="figure">
                        <!-- .figure-img -->
                        <div class="figure-attachment">
                          <img src="assets/images/dummy/img-8.jpg" alt="Card image cap">
                        </div><!-- /.figure-img -->
                        <figcaption class="figure-caption">
                          <ul class="list-inline d-flex text-muted mb-0">
                ...
                <!-- .section-block -->
                <div class="section-block">
                  <h2 class="section-title"> Photoswipe </h2>
                  <p class="text-muted"> JavaScript image gallery for mobile and desktop. </p>
                </div><!-- /.section-block -->
                <!-- grid row -->
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="card card-figure">
                      ...
                      <figure class="figure">
                        <!-- .figure-img -->
                        <div class="figure-img">
                          <img class="img-fluid" src="assets/images/dummy/img-5.jpg" alt="Card image cap"> <a href="assets/images/dummy/img-5.jpg" class="img-link" data-size="600x450"><span class="tile tile-circle bg-danger"><span class="oi oi-eye"></span></span> <span class="img-caption d-none">Image caption goes here</span></a>
                          <div class="figure-action">
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="card card-figure">
                      ...
                      <figure class="figure">
                        <!-- .figure-img -->
                        <div class="figure-img">
                          <img class="img-fluid" src="assets/images/dummy/img-6.jpg" alt="Card image cap"> <a href="assets/images/dummy/img-6.jpg" class="img-link" data-size="600x450"><span class="tile tile-circle bg-danger"><span class="oi oi-eye"></span></span> <span class="img-caption d-none">Image caption goes here</span></a>
                          <div class="figure-action">
                            <a href="#" class="btn btn-block btn-sm btn-primary">View Details</a>
                          </div>
                        </div><!-- /.figure-img -->
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="card card-figure">
                      ...
                      <figure class="figure">
                        <!-- .figure-img -->
                        <div class="figure-img">
                          <img class="img-fluid" src="assets/images/dummy/img-2.jpg" alt="Card image cap"> <a href="assets/images/dummy/img-2.jpg" class="img-link" data-size="600x450"><span class="tile tile-circle bg-danger"><span class="oi oi-eye"></span></span> <span class="img-caption d-none">Image caption goes here</span></a>
                          <div class="figure-action">
                            <a href="#" class="btn btn-block btn-sm btn-primary">View Details</a>
                          </div>
                        </div><!-- /.figure-img -->
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="card card-figure">
                      ...
                      <figure class="figure">
                        <!-- .figure-img -->
                        <div class="figure-img">
                          <img class="img-fluid" src="assets/images/dummy/img-3.jpg" alt="Card image cap"> <a href="assets/images/dummy/img-3.jpg" class="img-link" data-size="600x450"><span class="tile tile-circle bg-danger"><span class="oi oi-eye"></span></span> <span class="img-caption d-none">Image caption goes here</span></a>
                          <div class="figure-action">
                            <a href="#" class="btn btn-block btn-sm btn-primary">View Details</a>
                          </div>
                        </div><!-- /.figure-img -->
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="card card-figure">
                      ...
                      <figure class="figure">
                        <!-- .figure-img -->
                        <div class="figure-img">
                          <img class="img-fluid" src="assets/images/dummy/img-1.jpg" alt="Card image cap"> <a href="assets/images/dummy/img-1.jpg" class="img-link" data-size="600x450"><span class="tile tile-circle bg-danger"><span class="oi oi-eye"></span></span> <span class="img-caption d-none">Image caption goes here</span></a>
                          <div class="figure-action">
                            <a href="#" class="btn btn-block btn-sm btn-primary">View Details</a>
                          </div>
                        </div><!-- /.figure-img -->
                ...
                <div class="section-block">
                  ...
                  <p class="text-muted"> A simple, accessible and customisable media player for HTML5 Video, HTML5 Audio, YouTube and Vimeo. </p>
                </div><!-- /.section-block -->
                <!-- grid row -->
                <div class="row">
                  <!-- grid column -->
                  <div class="col-xl-4 col-sm-6">
                    <!-- .card -->
                    <div class="card">
                      <video data-toggle="plyr" controls="" crossorigin="" playsinline="" poster="../cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.jpg">
                        <!-- Video files -->
                  ...
                  <div class="col-xl-4 col-sm-6">
                    ...
                    <div class="card">
                      <!-- youtube -->
                      <div data-toggle="plyr" data-plyr-provider="youtube" data-plyr-embed-id="bTqVqk7FSmY"></div><!-- /youtube -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-xl-4 col-sm-6">
                    ...
                    <div class="card">
                      <!-- vimeo -->
                      <div data-toggle="plyr" data-plyr-provider="vimeo" data-plyr-embed-id="147865858"></div><!-- /vimeo -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-xl-4 col-sm-6">
                    ...
                    <div class="card">
                      ...
                      <audio data-toggle="plyr" controls="">
                        ...
                        <source src="https://cdn.plyr.io/static/demo/Kishi_Bashi_-_It_All_Began_With_a_Burst.ogg" type="audio/ogg"></audio> <!-- /audio -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                </div><!-- /grid row -->
              </div><!-- /.page-section -->
    ...
    <script src="assets/vendor/plyr/plyr.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="assets/javascript/theme.min.js"></script> <!-- END THEME JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/photoswipe-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/component-rich-media.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:13 GMT -->
</html>