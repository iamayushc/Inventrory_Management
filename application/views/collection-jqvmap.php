...
<!-- Mirrored from uselooper.com/collection-jqvmap.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:38 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="assets/vendor/jqvmap-novulnerability/jqvmap.min.css">
  ...
  <body>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title mr-sm-auto"> jQuery Vector Map </h1>
                <p class="text-muted"> jQuery plugin that renders Vector Maps. </p>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div id="vmap-world" class="vmap" style="height: 300px"></div>
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div id="vmap-usa" class="vmap" style="height: 300px"></div>
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div id="vmap-europe" class="vmap" style="height: 300px"></div>
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div id="vmap-germany" class="vmap" style="height: 300px"></div>
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                </div><!-- /grid row -->
              </div><!-- /.page-section -->
    ...
    <script src="assets/vendor/jqvmap-novulnerability/jquery.vmap.min.js"></script>
    <script src="assets/vendor/jqvmap-novulnerability/maps/jquery.vmap.world.js"></script>
    <script src="assets/vendor/jqvmap-novulnerability/maps/jquery.vmap.usa.js"></script>
    <script src="assets/vendor/jqvmap-novulnerability/maps/jquery.vmap.germany.js"></script>
    <script src="assets/vendor/jqvmap-novulnerability/maps/continents/jquery.vmap.europe.js"></script>
    <script src="assets/vendor/toastr/build/toastr.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="assets/javascript/theme.min.js"></script> <!-- END THEME JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/jqvmap-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/collection-jqvmap.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:41 GMT -->
</html>