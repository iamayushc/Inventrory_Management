...
<!-- Mirrored from uselooper.com/page-team.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:41 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Bootstrap Team Overview | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Bootstrap Team Overview">
    ...
    <script type="application/ld+json">
      {
        ...
        "@type": "WebSite",
        "url": "",
        "headline": "Bootstrap Team Overview",
  ...
  <body>
              ...
              <header class="page-title-bar">
                ...
                <div class="nav-scroller border-bottom">
                  ...
                  <div class="nav nav-tabs">
                    <a class="nav-link active" href="page-team.html">Overview</a> <a class="nav-link" href="page-team-feeds.html">Feeds</a> <a class="nav-link" href="page-team-projects.html">Projects</a> <a class="nav-link" href="page-team-members.html">Members</a> <a class="nav-link" href="#">Settings</a>
                  </div><!-- /.nav -->
                </div><!-- /.nav-scroller -->
                  ...
                  <div class="card card-fluid">
                    ...
                    <div class="list-group list-group-bordered list-group-reflow">
                      <div class="list-group-item justify-content-between align-items-center">
                        <span><i class="fas fa-square text-purple mr-2"></i> New</span> <span class="text-muted">30%</span>
                      </div>
                      <div class="list-group-item justify-content-between align-items-center">
                        <span><i class="fas fa-square text-pink mr-2"></i> Initial Contact</span> <span class="text-muted">20.5%</span>
                      </div>
                      <div class="list-group-item justify-content-between align-items-center">
                        <span><i class="fas fa-square text-yellow mr-2"></i> Qualified</span> <span class="text-muted">13%</span>
                      </div>
                      <div class="list-group-item justify-content-between align-items-center">
                        <span><i class="fas fa-square text-green mr-2"></i> Proposal</span> <span class="text-muted">9.75%</span>
                      </div>
                      <div class="list-group-item justify-content-between align-items-center">
                        <span><i class="fas fa-square text-teal mr-2"></i> Conversion to clients</span> <span class="text-muted">1.5%</span>
                      </div>
                    </div><!-- /.list-group -->
                  </div><!-- /.card -->
                  <!-- .card -->
                    ...
                    <div class="list-group list-group-flush">
                      ...
                      <div class="list-group-item">
                        ...
                        <div class="list-group-item-figure">
                          <a href="user-profile.html" class="user-avatar" data-toggle="tooltip" title="Martha Myers"><img src="assets/images/avatars/uifaces19.jpg" alt=""></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <!-- .progress -->
                          <div class="progress progress-animated rounded-0" data-toggle="tooltip" data-html="true" title='&lt;div class="text-left small"&gt;&lt;i class="fa fa-fw fa-square text-teal"&gt;&lt;/i&gt; 275&lt;br&gt;&lt;i class="fa fa-fw fa-square text-indigo"&gt;&lt;/i&gt; 614&lt;br&gt;&lt;i class="fa fa-fw fa-square text-pink"&gt;&lt;/i&gt; 534&lt;br&gt;&lt;i class="fa fa-fw fa-square text-purple"&gt;&lt;/i&gt; 388&lt;/div&gt;'>
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="user-profile.html" class="user-avatar" data-toggle="tooltip" title="Kyle Grant"><img src="assets/images/avatars/uifaces16.jpg" alt=""></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <!-- .progress -->
    ...
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/team-overview-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/page-team.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:42 GMT -->
</html>