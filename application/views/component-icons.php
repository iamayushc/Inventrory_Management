...
<!-- Mirrored from uselooper.com/component-icons.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:11 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Icon Sets | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Icon Sets">
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <p class="text-muted"> Come with three icon sets, includes 223 <a href="https://useiconic.com/open" target="_blank">Open Iconic</a>, 1,544 <a href="https://fontawesome.com/icons?d=gallery&amp;m=free" target="_blank">Font Awesome</a> Icons, and Official <a href="https://icons.getbootstrap.com/">Bootstrap Icons v1.0.0-alpha</a>. </p>
                    ...
                    <div class="card card-fluid">
                      ...
                      <div class="card-body">
                        ...
                        <ul class="list-icons mb-3">
                          <li>
                            <span class="list-icon"><span class="oi oi-check text-primary"></span></span> Ullam odit vel at, commodi atque ratione? </li>
                          <li>
                            <span class="list-icon"><span class="oi oi-media-record text-pink pulse"></span></span> Eligendi aliquid quis reprehenderit, officia fuga vero. </li>
                          <li>
                            <span class="list-icon"><span class="oi oi-circle-check text-success"></span></span> Nostrum perspiciatis laboriosam mollitia assumenda beatae distinctio! </li>
                          <li>
                            <span class="list-icon"><span class="oi oi-media-record text-warning"></span></span> In, nulla dolor. Suscipit facilis molestiae architecto? </li>
                          <li>
                            <span class="list-icon"><span class="fa fa-times text-red"></span></span> Blanditiis non voluptas numquam incidunt eum temporibus! </li>
                        </ul>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <ul class="list-group list-group-flush list-group-bordered">
                        ...
                        <li class="list-group-item">
                          <div class="list-group-item-figure">
                            <div class="tile tile-circle bg-success">
                              <span class="oi oi-chat"></span>
                            </div>
                          </div>
                          <div class="list-group-item-body"> Dapibus ac facilisis in </div>
                        ...
                        <li class="list-group-item">
                          <div class="list-group-item-figure">
                            <div class="tile tile-circle bg-warning">
                              <span class="oi oi-tags"></span>
                            </div>
                          </div>
                          <div class="list-group-item-body"> Porta ac consectetur ac </div>
