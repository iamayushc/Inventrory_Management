...
<!-- Mirrored from uselooper.com/collection-inline-charts.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:38 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Inline Charts | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Inline Charts">
  ...
  <body>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title mr-sm-auto"> Inline Charts </h1>
                <p class="text-muted"> Generate small sparkline charts directly in the browser. </p>
              ...
              <div class="page-section">
                ...
                <div class="card">
                  <!-- .card-header -->
                  <div class="card-header"> Sparklines </div><!-- /.card-header -->
                  <!-- .card-body -->
                  <div class="card-body">
                    <!-- grid row -->
                    <div class="row">
                      <!-- grid column -->
                      <div class="col-md-6">
                        <p> Mouse speed <span id="mousespeed">Loading..</span>
                        </p>
                        <p> Inline <span data-toggle="sparkline" data-line-color="#00A28A" data-fill-color="#E0F8F4">10,8,9,3,5,8,5</span> line graphs <span data-toggle="sparkline" data-line-color="#00A28A" data-fill-color="#E0F8F4">8,4,0,0,0,0,1,4,4,10,10,10,10,0,0,0,4,6,5,9,10</span>
                        </p>
                        <p> Bar charts <span data-toggle="sparkline" data-type="bar" data-bar-color="#00A28A" data-neg-bar-color="#B76BA3" data-stacked-bar-color='["#00A28A", "#5F4B8B", "#346CB0", "#F7C46C"]'>10,8,9,3,5,8,5</span> negative values: <span data-toggle="sparkline" data-type="bar" data-bar-color="#00A28A" data-neg-bar-color="#B76BA3" data-stacked-bar-color='["#00A28A", "#5F4B8B", "#346CB0", "#F7C46C"]'>-3,1,2,0,3,-1</span> stacked: <span data-toggle="sparkline" data-type="bar" data-bar-color="#00A28A" data-neg-bar-color="#B76BA3" data-stacked-bar-color='["#00A28A", "#5F4B8B", "#346CB0", "#F7C46C"]'>0:2,2:4,4:2,4:1</span>
                        </p>
                        <p> Composite inline <span id="compositeline">8,4,0,0,0,0,1,4,4,10,10,10,10,0,0,0,4,6,5,9,10</span>
                        </p>
                        <p> Inline with normal range <span data-toggle="sparkline" data-fill-color="false" data-normal-range-min="-1" data-normal-range-max="8" data-line-color="#00A28A" data-normal-range-color="#F5F5F5">8,4,0,0,0,0,1,4,4,10,10,10,10,0,0,0,4,6,5,9,10</span>
                        </p>
                        <p> Composite bar <span id="compositebar">4,6,7,7,4,3,2,1,4</span>
                        </p>
                        <p> Discrete <span data-toggle="sparkline" data-type="discrete" data-line-color="#346CB0" data-xwidth="18">4,6,7,7,4,3,2,1,4,4,5,6,7,6,6,2,4,5</span><br> Discrete with threshold <span data-toggle="sparkline" data-type="discrete" data-line-color="#346CB0" data-threshold-color="#B76BA3" data-threshold-value="4">4,6,7,7,4,3,2,1,4</span>
                        </p>
                        <p> Customize size and colours <span data-toggle="sparkline" data-height="1.5em" data-width="8em" data-line-color="#00A28A" data-fill-color="#E7F6F4" data-min-spot-color="false" data-max-spot-color="false" data-spot-color="#F7C46C" data-spot-radius="3">10,8,9,3,5,8,5,7</span>
                        </p>
                      </div><!-- /grid column -->
                      <!-- grid column -->
                      <div class="col-md-6">
                        <p> Tristate charts <span data-toggle="sparkline" data-type="tristate" data-pos-bar-color="#00A28A" data-neg-bar-color="#B76BA3">1,1,0,1,-1,-1,1,-1,0,0,1,1</span><br>
                          <small>(think games won, lost or drawn)</small>
                        </p>
                        <p> Tristate chart using a colour map: <span data-toggle="sparkline" data-type="tristate" data-color-map='{ "0":"#5F4B8B", "1":"#00A28A", "2":"#346CB0", "-2":"#B76BA3", "-1":"#F7C46C" }'>1,2,0,2,-1,-2,1,-2,0,0,1,1</span>
                        </p>
                        <p> Box Plot: <span data-toggle="sparkline" data-type="box" data-line-color="#5F4B8B" data-box-line-color="#5F4B8B" data-whisker-color="#BEC1C4" data-outlier-line-color="#BEC1C4" data-outlier-fill-color="#D4D5D7" data-median-color="#B76BA3" data-target-color="#F7C46C">4,27,34,52,54,59,61,68,78,82,85,87,91,93,100</span><br> Pre-computed box plot <span data-toggle="sparkline" data-type="box" data-values='[1, 3, 5, 8, 10, 15, 18]' data-raw="true" data-show-outliers="true" data-target="6" data-line-color="#346CB0" data-box-line-color="#346CB0" data-whisker-color="#BEC1C4" data-outlier-line-color="#BEC1C4" data-outlier-fill-color="#F5F5F5" data-median-color="#B76BA3" data-target-color="#F7C46C">Loading..</span>
                        </p>
                        <p> Pie charts <span data-toggle="sparkline" data-type="pie" data-height="1.0em" data-slice-colors='["#5F4B8B","#00A28A","#346CB0","#F7C46C"]'>1,1,2</span> <span data-toggle="sparkline" data-type="pie" data-height="1.0em" data-slice-colors='["#5F4B8B","#00A28A","#346CB0","#F7C46C"]'>1,5</span> <span data-toggle="sparkline" data-type="pie" data-height="1.0em" data-slice-colors='["#5F4B8B","#00A28A","#346CB0","#F7C46C"]'>20,50,80</span>
                        </p>
                        <p> Bullet charts<br>
                          <span data-toggle="sparkline" data-type="bullet" data-target-color="#B76BA3" data-performance-color="#00A28A" data-range-colors='["#C0F0E8","#A1E9DD","#82E2D2"]'>10,12,12,9,7</span><br>
                          <span data-toggle="sparkline" data-type="bullet" data-target-color="#B76BA3" data-performance-color="#00A28A" data-range-colors='["#C0F0E8","#A1E9DD","#82E2D2"]'>14,12,12,9,7</span><br>
                          <span data-toggle="sparkline" data-type="bullet" data-target-color="#B76BA3" data-performance-color="#00A28A" data-range-colors='["#C0F0E8","#A1E9DD","#82E2D2"]'>10,12,14,9,7</span><br>
                        </p>
                      </div><!-- /grid column -->
                    </div><!-- /grid row -->
                  </div><!-- /.card-body -->
                ...
                <div class="section-block">
                  <h2 class="section-title"> Easy Pie Chart </h2>
                  <p class="text-muted"> Lightweight jQuery plugin to draw simple, animated pie charts for single values. </p>
                </div><!-- /.section-block -->
                <!-- grid row -->
                <div class="row">
                  <!-- grid column -->
                    ...
                    <div class="card card-fluid">
                      <div class="card-body">
                        ...
                        <div class="text-center">
                          <div class="easypiechart mb-1" data-toggle="easypiechart" data-percent="50" data-bar-color="#346CB0" data-track-color="false">
                            <span>45%</span>
                          </div><span>New visits</span>
                        </div><!-- /easy-pie-chart -->
                      </div>
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  ...
                  <div class="col-12 col-sm-6 col-xl-3">
                    ...
                    <div class="card card-fluid">
                      <div class="card-body">
                        <!-- easy-pie-chart -->
                        <div class="text-center">
                          <div class="easypiechart mb-1" data-toggle="easypiechart" data-percent="60" data-bar-color="#00A28A" data-track-color="#E7F6F4">
                            <span>60%</span>
                          </div><span>Bounce rate</span>
                        </div><!-- /easy-pie-chart -->
                      </div>
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  ...
                  <div class="col-12 col-sm-6 col-xl-3">
                    ...
                    <div class="card card-fluid">
                      <div class="card-body">
                        <!-- easy-pie-chart -->
                        <div class="text-center">
                          <div class="chart-inline-group">
                            <div class="easypiechart mb-1" data-toggle="easypiechart" data-percent="75" data-bar-color="#B76BA3" data-track-color="false" data-scale-color="false" data-rotate="225"></div>
                            <div class="easypiechart mb-1" data-toggle="easypiechart" data-percent="60" data-size="90" data-bar-color="#5F4B8B" data-track-color="false" data-scale-color="false" data-rotate="225"></div>
                            <div class="easypiechart mb-1" data-toggle="easypiechart" data-percent="75" data-size="60" data-bar-color="#A7C796" data-track-color="false" data-scale-color="false" data-rotate="225"></div>
                          </div><span>Returning</span>
                        </div><!-- /easy-pie-chart -->
                      </div>
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  ...
                  <div class="col-12 col-sm-6 col-xl-3">
                    ...
                    <div class="card card-fluid">
                      <div class="card-body">
                        <!-- easy-pie-chart -->
                        <div class="text-center">
                          <div class="easypiechart mb-1" data-toggle="easypiechart" data-percent="85" data-bar-color="#F9AC2F" data-track-color="#FEF7EC" data-scale-color='false'>
                            <span>85%</span>
                          </div><span>Conversions</span>
                        </div><!-- /easy-pie-chart -->
                      </div>
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                ...
                <div class="section-block">
                  ...
                  <p class="text-muted"> Nice, downward compatible, touchable, jQuery dial. </p>
                </div><!-- /.section-block -->
                <!-- grid row -->
                <div class="row">
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> Disable display input </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input data-toggle="knob" data-displayinput="false" value="35">
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> 'cursor' mode </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input data-toggle="knob" data-cursor="true" data-fgcolor="#5F4B8B" data-thickness=".3" value="29">
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> Display previous value </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input data-toggle="knob" data-min="-100" data-displayprevious="true" value="44">
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> Angle offset </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input data-toggle="knob" data-angleoffset="90" data-linecap="round" value="35">
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> offset and arc </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input data-toggle="knob" data-angleoffset="-125" data-anglearc="250" data-fgcolor="#B76BA3" data-rotation="anticlockwise" value="35">
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> 4-digit, step 0.1 </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input data-toggle="knob" data-width="100%" data-min="-10000" data-displayprevious="true" data-max="10000" data-step=".1" value="0">
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> Overloaded 'draw' method #1 </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input data-toggle="knob" data-width="100%" data-displayprevious="true" data-skin="tron" data-cursor="true" value="75" data-thickness=".2">
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> Overloaded 'draw' method #2 </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input data-toggle="knob" data-width="100%" data-displayprevious="true" data-fgcolor="#5F4B8B" data-skin="tron" data-thickness=".2" value="75">
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> Overloaded 'draw' method #3 </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input data-toggle="knob" data-width="100%" data-angleoffset="180" data-fgcolor="#F7C46C" data-skin="tron" data-thickness=".1" value="35">
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> Responsive </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input data-toggle="knob" data-width="100%" value="35">
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> Readonly </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input data-toggle="knob" data-fgcolor="#EA6759" data-thickness=".4" value="22" readonly>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-header -->
                      <div class="card-header"> Dynamic </div><!-- /.card-header -->
                      <!-- .card-body -->
                      <div class="card-body text-center">
                        <input type="text" class="knob-dyn" data-width="200" data-cursor="true" data-fgcolor="#00A28A" data-bgcolor="transparent" value="56">
                      </div><!-- /.card-body -->
                      <!-- .card-footer -->
                      <div class="card-footer">
                        <a href="#" class="card-footer-item" onclick="event.preventDefault(); $('.knob-dyn').knob();">Knobify!</a>
                      </div><!-- /.card-footer -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                </div><!-- /grid row -->
    ...
    <script src="assets/vendor/jquery-knob/jquery.knob.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="assets/javascript/theme.min.js"></script> <!-- END THEME JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/sparkline-demo.js"></script> <!-- END PAGE LEVEL JS -->
