...
<!-- Mirrored from uselooper.com/page-project-board.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:44 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Kanban Board | Looper - Bootstrap 4 Admin Theme </title>
                          ...
                          <div class="list-group">
                            ...
                            <div class="list-group-item" data-toggle="modal" data-target="#modalViewTask">
                              ...
                              <div class="list-group-item-body">
                                ...
                                <figure class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Craig Hansen">
                                  <img src="assets/images/avatars/uifaces5.jpg" alt="Craig Hansen">
                                </figure>
                                <figure class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Jane Barnes">
                                  <img src="assets/images/avatars/uifaces9.jpg" alt="Jane Barnes">
                                </figure><!-- /members -->
                              </div><!-- /.list-group-item-body -->
                            </div><!-- /.list-group-item -->
                            <!-- .list-group-item -->
...
layer modal with dinamy content to handle your menus (overview, members, time tracking, and so on) -->
          ...
          <!-- /Layer #2 Modal -->
          <!-- .form -->
          <form id="addNewTask" action="https://uselooper.com/add-new-task" method="post" enctype="multipart/form-data" name="addNewTask">
            <!-- .modal -->
                    ...
                    <div class="form-group form-row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="dropdown">
                            <button type="button" class="btn btn-secondary btn-block d-flex justify-content-between align-items-center" id="dntAssignees" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span>Beni Arisandi + 1 more</span> <span class="fa fa-angle-down"></span></button> <!-- .dropdown-menu -->
                            <div class="dropdown-menu dropdown-menu-md overflow-y-auto stop-propagation" data-flip="false" id="dntmAssignees" aria-labelledby="dropdownAssignee1" style="max-height: 30rem;">
                        ...
                        <div class="form-group">
                          ...
                          <div class="dropdown">
                            <button type="button" class="btn btn-secondary btn-block d-flex justify-content-between align-items-center" id="bntLabels" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span>No label</span> <span class="fa fa-angle-down"></span></button> <!-- .dropdown-menu -->
            ...
            <div class="modal-dialog modal-lg modal-drawer-right" role="document">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body p-3 p-lg-4">
                  ...
                  <hr>
                  <p class="text-muted"> Opened one week ago by <a href="#" class="link-text" data-toggle="tooltip" title="@jgrif"><span class="user-avatar user-avatar-xs"><img src="assets/images/avatars/uifaces6.jpg" alt=""></span> Jacob Griffin</a>
                  </p>
                  <hr>
                  ...
                  <div class="row my-3">
                    ...
                    <div class="col-6 mb-3">
                      ...
                      <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-md stop-propagation" id="dntmLabels" aria-labelledby="dropdownTaskLabels2">
                    ...
                    <div class="col-6 mb-3">
                      ...
                      <div class="assignee">
                        ...
                        <div class="avatar-group">
                          <a href="#" class="user-avatar" data-toggle="tooltip" title="You"><img src="assets/images/avatars/uifaces2.jpg" alt="You"></a> <a href="#" class="user-avatar" data-toggle="tooltip" title="Mellisa Day"><img src="assets/images/avatars/uifaces4.jpg" alt="Mellisa Day"></a>
                          <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-md overflow-auto stop-propagation" aria-labelledby="dropdownAssignee2" style="max-height: 30rem;">
                              ...
                              <div class="dropdown-divider"></div>
                              <h6 class="dropdown-header"> Assignee(s) </h6><label class="custom-control custom-checkbox filterable" data-sort="Beni Arisandi"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="4" data-label="Beni Arisandi" checked> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="assets/images/avatars/uifaces2.jpg" alt=""></span></span> <span class="media-body">Beni Arisandi<br>
                                      <span class="text-muted">@benz</span></span></span></span></label> <label class="custom-control custom-checkbox filterable" data-sort="Melissa Day"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="2" data-label="Melissa Day" checked> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="assets/images/avatars/uifaces4.jpg" alt=""></span></span> <span class="media-body">Melissa Day<br>
                                      <span class="text-muted">@melday</span></span></span></span></label>
                              <div id="dntmDivider" class="dropdown-divider"></div><label class="custom-control custom-checkbox filterable" data-sort="Adam Medina"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="3" data-label="Adam Medina"> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="assets/images/avatars/uifaces15.jpg" alt=""></span></span> <span class="media-body">Adam Medina<br>
                                      <span class="text-muted">@amed</span></span></span></span></label> <label class="custom-control custom-checkbox filterable" data-sort="Diana Miller"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="1" data-label="Diana Miller"> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="assets/images/avatars/uifaces9.jpg" alt=""></span></span> <span class="media-body">Diana Miller<br>
                                      <span class="text-muted">@dmiller</span></span></span></span></label> <label class="custom-control custom-checkbox filterable" data-sort="Douglas Lucas"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="5" data-label="Douglas Lucas"> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="assets/images/avatars/uifaces5.jpg" alt=""></span></span> <span class="media-body">Douglas Lucas<br>
                                      <span class="text-muted">@lucaldoug</span></span></span></span></label>
                            </div><!-- /.dropdown-menu -->
                          </div>
    ...
    <script src="assets/vendor/flatpickr/flatpickr.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="assets/javascript/theme.min.js"></script> <!-- END THEME JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/board-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/page-project-board.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:46 GMT -->
</html>