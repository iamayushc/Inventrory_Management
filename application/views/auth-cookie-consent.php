...
<!-- Mirrored from uselooper.com/auth-cookie-consent.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:53 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Cookie Consent | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Cookie Consent">
    ...
    <link rel="stylesheet" href="assets/vendor/cookieconsent/build/cookieconsent.min.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
  ...
  <body>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Cookie Consent </h1>
                <p class="text-muted"> A solution to the EU Cookie Law. </p>
              </header><!-- /.page-title-bar -->
              <!-- .page-section -->
              <div class="page-section">
                <div id="cookieDemo"></div><!-- .section-block -->
                <div class="section-block">
                  <div class="alert alert-secondary">
                    <span class="fa fa-lg fa-info-circle text-muted mr-2"></span> If the cookie popup doesn't appear, try to open this page with <strong>browser incognito</strong> or clean your cookie. </div>
                </div><!-- /.section-block -->
              </div><!-- /.page-section -->
            </div><!-- /.page-inner -->
          </div><!-- /.page -->
    ...
    <script src="assets/vendor/cookieconsent/build/cookieconsent.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="assets/javascript/theme.min.js"></script> <!-- END THEME JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/cookieconsent-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/auth-cookie-consent.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:54 GMT -->
</html>