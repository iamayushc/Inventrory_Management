...
<!-- Mirrored from uselooper.com/collection-chartjs-bar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:33 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Chart.js Bar | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Chart.js Bar">
  ...
  <body>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title mr-sm-auto"> Bar </h1>
                <p class="text-muted"> A bar chart is a way of showing data as bars. It is sometimes used to show trend data, and the comparison of multiple data sets side by side. </p>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-horizontal-bar" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                      <!-- .card-footer -->
                      <div class="card-footer">
                        <a href="#" id="randomizeDataHorizontalBar" class="card-footer-item card-footer-item-bordered text-muted">Randomize <span class="d-none d-sm-inline">Data</span></a> <a href="#" id="addDatasetHorizontalBar" class="card-footer-item card-footer-item-bordered text-muted">Add <span class="d-none d-sm-inline">Dataset</span></a> <a href="#" id="removeDatasetHorizontalBar" class="card-footer-item card-footer-item-bordered text-muted">Remove <span class="d-none d-sm-inline">Dataset</span></a>
                      </div><!-- /.card-footer -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-stacked" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-stacked-group" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
    ...
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/chartjs-bar-demo.js"></script> <!-- END PAGE LEVEL JS -->
