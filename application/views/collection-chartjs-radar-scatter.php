...
<!-- Mirrored from uselooper.com/collection-chartjs-radar-scatter.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:33 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Chart.js Radar & Scatter | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Chart.js Radar &amp; Scatter">
    ...
    <script type="application/ld+json">
      {
        ...
        "@type": "WebSite",
        "url": "",
        "headline": "Chart.js Radar & Scatter",
  ...
  <body>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title mr-sm-auto"> Radar & Scatter </h1>
                <p class="text-muted"> A radar chart is a way of showing multiple data points and the variation between them. They are often useful for comparing the points of two or more different data sets. </p>
              ...
              <div class="page-section">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div class="card-body">
                        <div style="position:relative; height:400px">
                          <canvas id="canvas-radar-skip-points"></canvas>
                        </div>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                ...
                <div class="section-block">
                  <h2 class="section-title"> Scatter Chart </h2>
                  <p class="text-muted"> Scatter charts are based on basic line charts with the x axis changed to a linear axis. To use a scatter chart, data must be passed as objects containing X and Y properties. </p>
                </div><!-- /.section-block -->
                <!-- grid row -->
                <div class="row">
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-scatter" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-scatter-multi-axis" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                </div><!-- /grid row -->
    ...
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/chartjs-scatter-demo.js"></script>
    <script src="assets/javascript/pages/chartjs-radar-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/collection-chartjs-radar-scatter.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:34 GMT -->
</html>