...
<!-- Mirrored from uselooper.com/form-editors.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:25 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Editors | Looper - Bootstrap 4 Admin Theme </title>
    ...
    <link rel="stylesheet" href="assets/vendor/simplemde/simplemde.min.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
            ...
            <div class="page-inner">
              ...
              <div class="page-section">
                ...
                <div class="card card-fluid">
                  <div class="card-body">
                    <!-- #summernote-airmode -->
                    <div data-toggle="summernote" data-air-mode="true" data-height="auto">
...
console.log(addResult);</pre>
    ...
    <script src="assets/vendor/ace-builds/src-min-noconflict/ext-statusbar.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="assets/javascript/theme.min.js"></script> <!-- END THEME JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/summernote-demo.js"></script>
    <script src="assets/javascript/pages/ace-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/form-editors.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:29 GMT -->
</html>