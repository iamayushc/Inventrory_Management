...
<!-- Mirrored from uselooper.com/collection-chartjs-line.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:33 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Chart.js Lines | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Chart.js Lines">
  ...
  <body>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title mr-sm-auto"> Line </h1>
                <p class="text-muted"> A line chart is a way of plotting data points on a line. Often, it is used to show trend data, and the comparison of two data sets. </p>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div class="card-footer">
                        <a href="#" id="randomizeData" class="card-footer-item card-footer-item-bordered text-muted">Randomize <span class="d-none d-sm-inline">Data</span></a> <a href="#" id="addData" class="card-footer-item card-footer-item-bordered text-muted">Add <span class="d-none d-sm-inline">Data</span></a> <a href="#" id="removeData" class="card-footer-item card-footer-item-bordered text-muted">Remove <span class="d-none d-sm-inline">Data</span></a>
                      </div><!-- /.card-footer -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-stacked-area" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                      <!-- .card-footer -->
                      <div class="card-footer">
                        <a href="#" id="randomizeDataStackedArea" class="card-footer-item card-footer-item-bordered text-muted">Randomize <span class="d-none d-sm-inline">Data</span></a> <a href="#" id="addDatasetStackedArea" class="card-footer-item card-footer-item-bordered text-muted">Add <span class="d-none d-sm-inline">Dataset</span></a> <a href="#" id="removeDatasetStackedArea" class="card-footer-item card-footer-item-bordered text-muted">Remove <span class="d-none d-sm-inline">Dataset</span></a>
                      </div><!-- /.card-footer -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-styles" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-stepped" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-skip-points" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-different-point-sizes" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-multi-axis" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-interpolation-modes" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                </div><!-- /grid row -->
    ...
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/chartjs-line-demo.js"></script> <!-- END PAGE LEVEL JS -->
