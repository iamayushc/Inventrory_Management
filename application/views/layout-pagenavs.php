...
<!-- Mirrored from uselooper.com/layout-pagenavs.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:59 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <nav class="page-navs">
              ...
              <div class="nav-scroller">
                ...
                <div class="nav nav-tabs">
                  <a class="nav-link active" href="#">Dashboard</a> <a class="nav-link" href="#">Activities <span class="badge">16</span></a> <a class="nav-link" href="#">Teams</a> <a class="nav-link" href="#">Projects</a> <a class="nav-link" href="#">Tasks</a> <a class="nav-link" href="#">Settings</a>
                </div><!-- /.nav -->
              </div><!-- /.nav-scroller -->
            </nav><!-- /.page-navs -->
            <!-- .page-inner -->
