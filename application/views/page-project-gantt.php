...
<!-- Mirrored from uselooper.com/page-project-gantt.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:46 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Gantt View | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Gantt View">
  ...
  <body>
          ...
          <div class="page">
            ...
            <div class="page-inner page-inner-fill">
              ...
              <header class="page-navs shadow-sm pr-3">
                ...
                <!-- right actions -->
                <div class="ml-auto">
                  <button type="button" class="btn btn-light" id="addTask">Add task</button> <button type="button" class="btn btn-light btn-icon" data-toggle="modal" data-target="#modalBoardConfig" title="Show menu"><i class="fa fa-cog fa-fw"></i></button>
                </div><!-- /right actions -->
              </header><!-- /.page-navs -->
              <!-- .board -->
    ...
    <script src="assets/vendor/snapsvg/snap.svg-min.js"></script>
    <script src="assets/vendor/frappe-gantt-v2/frappe-gantt.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="assets/javascript/theme.min.js"></script> <!-- END THEME JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/gantt-view-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/page-project-gantt.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:48 GMT -->
</html>