...
<!-- Mirrored from uselooper.com/collection-flot-charts.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:35 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title mr-sm-auto"> Flot Charts </h1>
                <p class="text-muted"> A pure JavaScript plotting library for jQuery, with a focus on simple usage, attractive looks and interactive features. </p>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div class="card-body">
                        ...
                        <div id="flot-line" class="flot"></div>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div class="card-body">
                        ...
                        <div id="flot-area" class="flot"></div>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      ...
                      <div class="card-body">
                        ...
                        <div id="flot-barhor" class="flot"></div>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <h3 class="card-title text-center"> Combine Chart </h3>
                        <div id="flot-combine" class="flot"></div>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <h3 class="card-title text-center"> Realtime Chart </h3>
                        <div id="flot-realtime" class="flot"></div>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                </div><!-- /grid row -->
    ...
    <script src="assets/vendor/flot/jquery.flot.time.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="assets/javascript/theme.min.js"></script> <!-- END THEME JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/jquery.flot.axislabels.min.js"></script>
    <script src="assets/javascript/pages/flot-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/collection-flot-charts.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:37 GMT -->
</html>