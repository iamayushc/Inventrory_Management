...
<!-- Mirrored from uselooper.com/page-project.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:43 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Project | Looper - Bootstrap 4 Admin Theme </title>
  ...
  <body>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row align-items-center">
                        <div class="col-12 col-sm-8">
                          <div class="chartjs">
                            <canvas id="canvas-invoices"></canvas>
                          </div>
                        </div>
    ...
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/project-overview-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/page-project.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:44 GMT -->
</html>