...
<!-- Mirrored from uselooper.com/page-teams.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:41 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Teams | Looper - Bootstrap 4 Admin Theme </title>
            ...
            <div class="page-inner">
              ...
              <div class="page-section">
                ...
                <div class="card card-fluid">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-auto d-none d-sm-flex">
                        <!-- .dropdown -->
                        <div class="dropdown">
                          <button class="btn btn-secondary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last updated <span class="fa fa-caret-down"></span></button> <!-- .dropdown-menu -->
                  ...
                  <div class="text-muted px-3 mb-2"> Showing 10 to 18 of 18 entries </div><!-- .tab-content -->
                  <div class="tab-content">
                    <!-- .tab-pane -->
                    <div class="tab-pane fade show active" id="project-myteams" role="tabpanel">
                      <!-- .list-group -->
                          ...
                          <div class="list-group-item-body">
                            <div class="d-sm-flex justify-content-sm-between align-items-sm-center">
                              ...
                              <ul class="list-inline text-muted mb-0">
                                <li class="list-inline-item mr-3" data-toggle="tooltip" title="Members" data-placement="bottom">
                                  <i class="fas fa-users text-teal"></i> 8 </li>
                                <li class="list-inline-item mr-3" data-toggle="tooltip" title="Clients" data-placement="bottom">
                                  <i class="fas fa-user-tie text-pink"></i> 3 </li>
                                <li class="list-inline-item mr-3" data-toggle="tooltip" title="Projects" data-placement="bottom">
                                  <i class="fa fa-bookmark text-yellow"></i> 4 </li>
                                <li class="list-inline-item" data-toggle="tooltip" title="Private">
                          ...
                          <div class="list-group-item-body">
                            <div class="d-sm-flex justify-content-sm-between align-items-sm-center">
                              ...
                              <ul class="list-inline text-muted mb-0">
                                ...
                                <li class="list-inline-item" data-toggle="tooltip" title="Public">
