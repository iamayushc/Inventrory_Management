...
<!-- Mirrored from uselooper.com/page-conversations.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:53 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Conversations | Looper - Bootstrap 4 Admin Theme </title>
  ...
  <body>
                  ...
                  <div id="team-profile" class="tab-pane fade show active" role="tabpanel" aria-labelledby="team-profile">
                    ...
                    <div class="card card-reflow border-bottom">
                      ...
                      <div class="card-body text-center">
                        <!-- team avatar -->
                        <a href="#" class="user-avatar user-avatar-xl my-3"><img src="assets/images/avatars/team4.jpg" alt=""></a> <!-- /team avatar -->
                        <h3 class="card-title text-truncate">
                          <a href="#">Creative Division</a>
                        </h3>
                      ...
                      <div class="card-footer">
                        ...
                        <div class="card-footer-item card-footer-item-bordered">
                          <!-- .metric -->
                          <div class="metric">
                            <p class="metric-label mb-1"> Clients </p>
                            <h6 class="metric-value"> 29 </h6>
                          </div><!-- /.metric -->
                        ...
                        <div class="card-footer-item card-footer-item-bordered">
                          ...
                          <div class="metric">
                            ...
                            <h6 class="metric-value"> 634.43K </h6>
                          </div><!-- /.metric -->
                        </div><!-- /.card-footer-item -->
                      </div><!-- /.card-footer -->
                    </div><!-- /.card -->
    ...
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/photoswipe-demo.js"></script>
    <script src="assets/javascript/pages/conversations-demo.js"></script> <!-- END PAGE LEVEL JS -->
