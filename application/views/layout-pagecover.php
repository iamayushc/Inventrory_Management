...
<!-- Mirrored from uselooper.com/layout-pagecover.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:59 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Page With Cover | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Page With Cover">
          ...
          <div class="page">
            ...
            <header class="page-cover">
              ...
              <div class="cover-controls cover-controls-bottom">
                <a href="#" class="btn btn-secondary"><i class="fas fa-user-plus mr-1"></i> <span>Follow</span></a> <a href="#" class="btn btn-secondary"><i class="fa fa-envelope fa-fw"></i> <span class="d-inline d-md-none">Messege</span></a>
              </div><!-- /.cover-controls -->
              <div class="text-center">
                ...
                <p class="text-muted"> @bent10 · Since Mar 10, 2018 </p>
              </div>
            </header><!-- /.page-cover -->
            <!-- .page-navs -->
            <nav class="page-navs">
              ...
              <div class="nav-scroller">
                ...
                <div class="nav nav-center nav-tabs">
                  <a class="nav-link active" href="#">Activities <span class="badge">16</span></a> <a class="nav-link" href="#">Teams</a> <a class="nav-link" href="#">Projects</a> <a class="nav-link" href="#">Tasks</a> <a class="nav-link" href="#">Settings</a>
                </div><!-- /.nav -->
              </div><!-- /.nav-scroller -->
            </nav><!-- /.page-navs -->
            <!-- .page-inner -->
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active">
                      <a href="user-profile.html"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Layouts</a>
                    </li>
                  </ol>
                </nav>
                <h1 class="page-title"> Page Cover </h1>
