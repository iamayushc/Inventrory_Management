...
<!-- Mirrored from uselooper.com/component-sortable-nestable.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:13 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
              ...
              <div class="page-section">
                ...
                <div class="row" data-toggle="sortable" data-draggable=".sortable-tile" data-handle=".drag-handle">
                  ...
                  <div class="col-lg-6 sortable-tile">
                    ...
                    <div class="card card-fluid">
                      <div class="card-header drag-handle"> Draft Items </div><!-- .sortable-lists -->
                  ...
                  <div class="col-lg-6 sortable-tile">
                    <!-- .card -->
                    <div class="card card-fluid">
                      <div class="card-header drag-handle"> Publish Items </div><!-- .sortable-lists -->
                      <ul class="sortable-lists list-group list-group-flush list-group-bordered" data-toggle="sortable" data-group="pages">
                        <li class="list-group-item align-items-center drag-handle">
                          <span class="drag-indicator"></span>
                          <div> Homepage </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <!-- .card -->
                    <div class="card card-fluid">
                      <div class="card-header border-bottom-0"> Footer Menus </div><!-- .nestable -->
                  ...
                  <div class="col-lg-6">
                    <!-- .card -->
                    <div class="card card-fluid">
                      <div class="card-header border-bottom-0"> Primary Menus </div><!-- .nestable -->
    ...
    <script src="assets/vendor/nestable2/jquery.nestable.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="assets/javascript/theme.min.js"></script> <!-- END THEME JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/nestable-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/component-sortable-nestable.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:15 GMT -->
</html>