...
<!-- Mirrored from uselooper.com/user-notification-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:59 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Notification Settings | Looper - Bootstrap 4 Admin Theme </title>
              ...
              <div class="page-section">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="card card-fluid">
                      ...
                      <nav class="nav nav-tabs flex-column border-0">
                        <a href="user-profile-settings.html" class="nav-link">Profile</a> <a href="user-account-settings.html" class="nav-link">Account</a> <a href="user-billing-settings.html" class="nav-link">Billing</a> <a href="user-notification-settings.html" class="nav-link active">Notifications</a>
                      </nav><!-- /.nav -->
                    </div><!-- /.card -->
                  </div><!-- /grid column -->
                  <!-- grid column -->
                  <div class="col-lg-8">
                    <!-- .card -->
                    <div class="card card-fluid">
                      <h6 class="card-header"> Notifications </h6><!-- .list-group -->
                      <div class="list-group list-group-flush">
                        <!-- .list-group-item -->
                        <div class="list-group-item d-flex justify-content-between align-items-center"> Someone follows you
                          <!-- .switcher -->
                          <label class="switcher-control switcher-control-success"><input type="checkbox" name="notif01" class="switcher-input" checked> <span class="switcher-indicator"></span></label> <!-- /.switcher -->
                        </div><!-- /.list-group-item -->
                        <!-- .list-group-item -->
                        ...
                        <div class="list-group-header"> Team Notifications </div><!-- .list-group-item -->
                        ...
                        <div class="list-group-header"> Project Notifications </div><!-- .list-group-item -->
                        <div class="list-group-item d-flex justify-content-between align-items-center"> Someone update a team
                          <!-- .switcher -->
                        ...
                        <div class="list-group-header"> News & Trending </div><!-- .list-group-item -->
