...
<!-- Mirrored from uselooper.com/layout-pagesidebar-hidden.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:59 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Page With Hidden Sidebar | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Page With Hidden Sidebar">
    ...
    <script type="application/ld+json">
      {
        ...
        "@type": "WebSite",
        "url": "",
        "headline": "Page With Hidden Sidebar",
          ...
          <div class="page has-sidebar">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Page with hidden sidebar </h1>
              </header><!-- /.page-title-bar -->
              <!-- .page-section -->
              <div class="page-section">
                <div class="section-block">
                  <div class="alert alert-info">
                    <strong>Yay!</strong> Now you can show the sidebar only when you need it. Please click button below to show the sidebar! </div><button class="btn btn-secondary" type="button" data-toggle="sidebar">Toggle sidebar</button>
                </div>
              </div><!-- /.page-section -->
            </div><!-- /.page-inner -->
            <!-- .page-sidebar -->
