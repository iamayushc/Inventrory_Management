...
<!-- Mirrored from uselooper.com/page-calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:48 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Calendar | Looper - Bootstrap 4 Admin Theme </title>
    ...
    <link rel="stylesheet" href="assets/vendor/fullcalendar/main.min.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
  ...
  <body>
          ...
          <div class="page has-sidebar has-sidebar-fixed has-sidebar-expand-xl">
            ...
            <div class="page-inner page-inner-fill">
              ...
              <nav class="page-navs pr-3">
                <div class="btn-group">
                  <button class="btn btn-secondary" data-toggle="calendarnav" data-nav="prev"><i class="fa fa-chevron-left"></i></button> <button class="btn btn-secondary" data-toggle="calendarnav" data-nav="today">Today</button> <button class="btn btn-secondary" data-toggle="calendarnav" data-nav="next"><i class="fa fa-chevron-right"></i></button>
                </div>
                <div class="ml-auto">
              ...
              <div class="board">
                <div class="card">
                  <header class="card-header d-flex flex-column flex-sm-row align-items-center justify-content-between">
                    <h5 class="card-title mb-sm-0" id="calendar-title"></h5>
                    <div class="btn-group">
                      <button type="button" class="btn btn-secondary active" data-toggle="calendarview" data-view="dayGridMonth">Month</button> <button type="button" class="btn btn-secondary" data-toggle="calendarview" data-view="timeGridWeek">Week</button> <button type="button" class="btn btn-secondary" data-toggle="calendarview" data-view="timeGridDay">Day</button>
                    </div>
                  </header>
                  <div id="calendar"></div>
                </div>
    ...
    <script src="assets/vendor/fullcalendar/main.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="assets/javascript/theme.min.js"></script> <!-- END THEME JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/fullcalendar-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/page-calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:49 GMT -->
</html>