...
<!-- Mirrored from uselooper.com/page-messages.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:39 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <nav class="page-navs">
              ...
              <div class="nav-scroller">
                ...
                <div class="nav nav-tabs">
                  <a class="nav-link active show" data-toggle="tab" href="#tab1">All <span class="badge">(7)</span></a> <a class="nav-link" data-toggle="tab" href="#tab2">Starred</a> <a class="nav-link" data-toggle="tab" href="#tab3">Trash</a>
                </div><!-- /.nav -->
              </div><!-- /.nav-scroller -->
            </nav><!-- /.page-navs -->
            <!-- .page-inner -->
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                <div class="d-flex justify-content-between">
                  <div class="d-md-inline-block">
                    ...
                    <div class="input-group input-group-alt">
                      ...
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text"><span class="oi oi-magnifying-glass"></span></span>
                        </div><input type="text" class="form-control" placeholder="Search message">
                      </div><!-- /.input-group -->
                      <!-- .input-group-append -->
                  ...
                  </div><button type="button" class="btn btn-success d-none d-sm-inline-block">New Message</button>
              ...
              <div class="page-section">
                ...
                <div class="card">
                  ...
                  <div class="list-group list-group-messages list-group-flush list-group-bordered">
                    ...
                    <div class="list-group-item unread">
                      ...
                      <div class="list-group-item-figure">
                        <span class="rating rating-sm mr-3"><input type="checkbox" id="star1" value="1"> <label for="star1"><span class="fa fa-star"></span></label></span> <!-- .avatar -->
                        <div class="avatar has-badge">
                          <a href="page-conversations.html" class="user-avatar"><img src="assets/images/avatars/team2.png" alt=""></a> <span class="tile tile-xs tile-circle bg-red">2</span>
                        </div><!-- /.avatar -->
                      </div><!-- /message figure -->
                      <!-- message body -->
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-lg-3 d-none d-lg-block">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Creative Division</a>
                            </h4>
                          ...
                          <div class="col-12 col-lg-9">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Our trip to Montreal</a>
                            </h4>
                      ...
                      <div class="list-group-item-figure">
                        ...
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-arrow mr-n1"></div><a href="#" class="dropdown-item">Mark as read</a> <a href="#" class="dropdown-item">Mark as unread</a> <a href="#" class="dropdown-item">Toggle star</a> <a href="#" class="dropdown-item">Trash</a>
                          </div><!-- /.dropdown-menu -->
                        </div><!-- /.dropdown -->
                      </div><!-- /message actions -->
                    </div><!-- /message item -->
                    ...
                    <div class="list-group-item unread">
                      <!-- message figure -->
                      <div class="list-group-item-figure">
                        <span class="rating rating-sm mr-3"><input type="checkbox" id="star2" value="1"> <label for="star2"><span class="fa fa-star"></span></label></span> <!-- .avatar -->
                        <div class="avatar has-badge">
                          <a href="page-conversations.html" class="tile tile-circle bg-teal">GD</a> <span class="tile tile-xs tile-circle bg-red">1</span>
                        </div><!-- /.avatar -->
                      </div><!-- /message figure -->
                      <!-- message body -->
                      <div class="list-group-item-body pl-md-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-lg-3 d-none d-lg-block">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Gold Dex</a>
                            </h4>
                          ...
                          <div class="col-12 col-lg-9">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">We are subscribed to local deals in Amsterdam</a>
                            </h4>
                    ...
                    <div class="list-group-item unread">
                      <!-- message figure -->
                      <div class="list-group-item-figure">
                        <span class="rating rating-sm mr-3"><input type="checkbox" id="star3" value="1" checked> <label for="star3"><span class="fa fa-star"></span></label></span> <!-- .avatar -->
                        <div class="avatar has-badge">
                          <a href="page-conversations.html" class="user-avatar"><img src="assets/images/avatars/team1.jpg" alt=""></a> <span class="tile tile-xs tile-circle bg-red">4</span>
                        </div><!-- /.avatar -->
                      </div><!-- /message figure -->
                      <!-- message body -->
                      <div class="list-group-item-body pl-md-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-lg-3 d-none d-lg-block">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Stilearning</a>
                            </h4>
                          ...
                          <div class="col-12 col-lg-9">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Invitation: Joe's Dinner @ Fri Aug 22</a>
                            </h4>
                    ...
                    <div class="list-group-item read">
                      <!-- message figure -->
                      <div class="list-group-item-figure">
                        <span class="rating rating-sm mr-3"><input type="checkbox" id="star4" value="1"> <label for="star4"><span class="fa fa-star"></span></label></span> <!-- .avatar -->
                        <div class="avatar">
                          <a href="page-conversations.html" class="user-avatar"><img src="assets/images/avatars/team3.png" alt=""></a>
                        </div><!-- /.avatar -->
                      </div><!-- /message figure -->
                      <!-- message body -->
                      <div class="list-group-item-body pl-md-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-lg-3 d-none d-lg-block">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Openlane</a>
                            </h4>
                          ...
                          <div class="col-12 col-lg-9">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Final reminder: Upgrade to Pro</a>
                            </h4>
                    ...
                    <div class="list-group-item read">
                      <!-- message figure -->
                      <div class="list-group-item-figure">
                        <span class="rating rating-sm mr-3"><input type="checkbox" id="star5" value="1"> <label for="star5"><span class="fa fa-star"></span></label></span> <!-- .avatar -->
                        <div class="avatar">
                          <a href="page-conversations.html" class="tile tile-circle bg-green">GZ</a>
                        </div><!-- /.avatar -->
                      </div><!-- /message figure -->
                      <!-- message body -->
                      <div class="list-group-item-body pl-md-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-lg-3 d-none d-lg-block">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Gogo Zoom</a>
                            </h4>
                          ...
                          <div class="col-12 col-lg-9">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Live healthy with this wireless sensor.</a>
                            </h4>
                    ...
                    <div class="list-group-item read">
                      <!-- message figure -->
                      <div class="list-group-item-figure">
                        <span class="rating rating-sm mr-3"><input type="checkbox" id="star6" value="1" checked> <label for="star6"><span class="fa fa-star"></span></label></span> <!-- .avatar -->
                        <div class="avatar">
                          <a href="page-conversations.html" class="tile tile-circle bg-teal">GD</a>
                        </div><!-- /.avatar -->
                      </div><!-- /message figure -->
                      <!-- message body -->
                      <div class="list-group-item-body pl-md-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-lg-9">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Invitation: Design Review @ Mon Jul 7</a>
                            </h4>
                    ...
                    <div class="list-group-item read">
                      <!-- message figure -->
                      <div class="list-group-item-figure">
                        <span class="rating rating-sm mr-3"><input type="checkbox" id="star7" value="1" checked> <label for="star7"><span class="fa fa-star"></span></label></span> <!-- .avatar -->
                        <div class="avatar">
                          <a href="page-conversations.html" class="user-avatar"><img src="assets/images/avatars/team2.png" alt=""></a>
                        </div><!-- /.avatar -->
                      </div><!-- /message figure -->
                      <!-- message body -->
                      <div class="list-group-item-body pl-md-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-lg-9">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Need some feedback on this please</a>
                            </h4>
                    ...
                    <div class="list-group-item read">
                      <!-- message figure -->
                      <div class="list-group-item-figure">
                        <span class="rating rating-sm mr-3"><input type="checkbox" id="star8" value="1"> <label for="star8"><span class="fa fa-star"></span></label></span> <!-- .avatar -->
                        <div class="avatar">
                          <a href="page-conversations.html" class="tile tile-circle bg-pink">LD</a>
                        </div><!-- /.avatar -->
                      </div><!-- /message figure -->
                      <!-- message body -->
                      <div class="list-group-item-body pl-md-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-lg-3 d-none d-lg-block">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Lab Drill</a>
                            </h4>
                          ...
                          <div class="col-12 col-lg-9">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Our UX exercise is ready</a>
                            </h4>
                    ...
                    <div class="list-group-item read">
                      <!-- message figure -->
                      <div class="list-group-item-figure">
                        <span class="rating rating-sm mr-3"><input type="checkbox" id="star9" value="1" checked> <label for="star9"><span class="fa fa-star"></span></label></span> <!-- .avatar -->
                        <div class="avatar">
                          <a href="page-conversations.html" class="tile tile-circle bg-red">C</a>
                        </div><!-- /.avatar -->
                      </div><!-- /message figure -->
                      <!-- message body -->
                      <div class="list-group-item-body pl-md-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-lg-3 d-none d-lg-block">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Codehow</a>
                            </h4>
                          ...
                          <div class="col-12 col-lg-9">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Digital VS. Education</a>
                            </h4>
                    ...
                    <div class="list-group-item read">
                      <!-- message figure -->
                      <div class="list-group-item-figure">
                        <span class="rating rating-sm mr-3"><input type="checkbox" id="star10" value="1"> <label for="star10"><span class="fa fa-star"></span></label></span> <!-- .avatar -->
                        <div class="avatar">
                          <a href="page-conversations.html" class="user-avatar"><img src="assets/images/avatars/team2.png" alt=""></a>
                        </div><!-- /.avatar -->
                      </div><!-- /message figure -->
                      ...
                      <div class="list-group-item-body pl-md-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-lg-9">
                            <h4 class="list-group-item-title text-truncate">
                              <a href="page-conversations.html">Work Inquiry from Poland</a>
                            </h4>
                  ...
                  </div><!-- /.list-group-messages -->
                </div><!-- /.card -->
                <!-- .section-block -->
                <div class="section-block">
                  <!-- record sumary -->
                  <p class="text-muted"> Showing 1 to 10 of 1,000 entries </p><!-- /record sumary -->
                  <!-- .pagination -->
