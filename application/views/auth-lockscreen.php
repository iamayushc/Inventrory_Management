...
<!-- Mirrored from uselooper.com/auth-lockscreen.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:56 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Locked | Looper - Bootstrap 4 Admin Theme </title>
    ...
    <main class="auth">
      ...
      <form class="auth-form">
        <div class="text-center mb-4">
          ...
          <h2 class="card-title"> Beni Arisandi </h2>
          <h6 class="card-subtitle text-muted"> bent10@looper.com </h6>
        </div><!-- .form-group -->
