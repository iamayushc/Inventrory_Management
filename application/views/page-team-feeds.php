...
<!-- Mirrored from uselooper.com/page-team-feeds.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:42 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Bootstrap Team Feeds | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Bootstrap Team Feeds">
    ...
    <link rel="stylesheet" href="assets/vendor/photoswipe/default-skin/default-skin.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
  ...
  <body>
              ...
              <header class="page-title-bar">
                ...
                <div class="nav-scroller border-bottom">
                  ...
                  <div class="nav nav-tabs">
                    <a class="nav-link" href="page-team.html">Overview</a> <a class="nav-link active" href="page-team-feeds.html">Feeds</a> <a class="nav-link" href="page-team-projects.html">Projects</a> <a class="nav-link" href="page-team-members.html">Members</a> <a class="nav-link" href="#">Settings</a>
                  </div><!-- /.nav -->
                </div><!-- /.nav-scroller -->
                      ...
                      <div class="media-body">
                        ...
                        <div class="publisher">
                          ...
                          <div class="publisher-input">
                            <textarea class="form-control" placeholder="What happening?"></textarea>
                          </div><!-- /.publisher-input -->
                          <!-- .publisher-actions -->
                  ...
                  <div class="feed">
                    ...
                    <div class="feed-post card">
                      ...
                      <div class="card-footer">
                        ...
                        <div class="card-footer-item">
                          <button type="button" class="btn btn-reset text-nowrap text-muted"><i class="fa fa-fw fa-comment"></i> Comment</button>
                        </div>
                        <div class="card-footer-item">
                            ...
                            <div class="conversation-message">
                              ...
                              <ul class="conversation-list">
                                ...
                                <li class="conversation-inbound">
                                  <div class="conversation-message">
                                    <div class="conversation-meta">
                                      <a href="#"><i class="fa fa-reply fa-rotate-180"></i></a> <a href="#" class="user-avatar user-avatar-xs mx-1"><img src="assets/images/avatars/uifaces16.jpg" alt=""></a> <a href="#">Betty Simmons · 5 Replies</a> · 12m </div>
                                  </div>
                                </li><!-- /.conversation-inbound -->
                              ...
                              <div class="card-figure">
                                ...
                                <figure class="figure">
                                  ...
                                  <div class="figure-img">
                                    <img class="img-fluid" src="assets/images/dummy/img-1.jpg" alt="Card image cap"> <a href="assets/images/dummy/img-1.jpg" class="img-link" data-size="600x450"><span class="tile tile-circle bg-danger"><span class="oi oi-eye"></span></span> <span class="img-caption d-none">Card image cap</span></a>
                                  </div><!-- /.figure-img -->
                                </figure><!-- /.card-figure -->
                              </div><!-- /.card-figure -->
                            </div>
                            <div class="attachment-item">
                              ...
                              <div class="card-figure">
                                ...
                                <figure class="figure">
                                  <!-- .figure-img -->
                                  <div class="figure-img">
                                    <img class="img-fluid" src="assets/images/dummy/img-4.jpg" alt="Card image cap"> <a href="assets/images/dummy/img-4.jpg" class="img-link" data-size="600x450"><span class="tile tile-circle bg-danger"><span class="oi oi-eye"></span></span> <span class="img-caption d-none">Card image cap</span></a>
                                  </div><!-- /.figure-img -->
                                </figure><!-- /.card-figure -->
                              </div><!-- /.card-figure -->
                            </div>
    ...
    <script src="assets/vendor/photoswipe/photoswipe-ui-default.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
...
<!-- Mirrored from uselooper.com/page-team-feeds.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:43 GMT -->
</html>