    ...
    <div class="page">
      ...
      <div class="page-inner">
        ...
        <header class="page-title-bar">
          ...
          <h1 class="page-title"> Edit Retailer </h1>
        ...
        <div class="page-section">
          ...
          <div class="card card-fluid">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo base_url().'Welcome/edit_retailer_script/'.$id?>" method="post">
                <!-- .form-group -->
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="control-label" for="uname">User Name</label>
                      <input type="text" id="uname" name="uname"class="form-control" value="<?php echo $username ?>" />
                    </div><!-- /.form-group -->
                    <div class="form-group">
                      <label class="control-label" for="rname">Retailer Name</label>
                      <input type="text" id="rname" name="rname"class="form-control" value="<?php echo $retailer_name ?>" />
                    </div><!-- /.form-group -->
                    <div class="form-group">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="cname" name="cname"class="form-control" value="<?php echo $company_name ?>" />
                    </div><!-- /.form-group -->
                    <div class="form-group">
                      <label class="control-label" for="mno">Mobile No</label>
                      <input type="number" id="mno" name="mno"class="form-control" value="<?php echo $mobile_no ?>"/>
                    </div><!-- /.form-group -->
