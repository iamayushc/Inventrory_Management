...
<!-- Mirrored from uselooper.com/layout-nosearch.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:59 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Header without Search | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Header without Search">
    ...
    <script type="application/ld+json">
      {
        ...
        "@type": "WebSite",
        "url": "",
        "headline": "Header without Search",
            ...
            <div class="top-bar-item top-bar-item-right px-0">
              ...
              <ul class="header-nav nav">
                ...
                <li class="nav-item dropdown header-nav-dropdown">
                  <a class="nav-link has-badge" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="badge badge-pill badge-warning">12</span> <span class="oi oi-pulse"></span></a> <!-- .dropdown-menu -->
