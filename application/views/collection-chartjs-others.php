...
<!-- Mirrored from uselooper.com/collection-chartjs-others.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:34 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Chart.js combo bar line, bubble, polar area, pie, donut | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Chart.js combo bar line, bubble, polar area, pie, donut">
    ...
    <script type="application/ld+json">
      {
        ...
        "@type": "WebSite",
        "url": "",
        "headline": "Chart.js combo bar line, bubble, polar area, pie, donut",
  ...
  <body>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <h1 class="page-title mr-sm-auto"> Others </h1>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-combo-bar-line" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /.col -->
                  <!-- .col -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-bubble" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /.col -->
                  <!-- .col -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-polar-area" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /.col -->
                  <!-- .col -->
                  <div class="col-lg-6">
                    ...
                    <div class="card card-fluid">
                      <!-- .card-body -->
                      <div class="card-body">
                        <canvas id="canvas-pie" class="chartjs"></canvas>
                      </div><!-- /.card-body -->
                    </div><!-- /.card -->
                  </div><!-- /.col -->
                  <!-- .col -->
    ...
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/chartjs-others-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/collection-chartjs-others.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:35 GMT -->
</html>