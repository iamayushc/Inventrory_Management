...
<!-- Mirrored from uselooper.com/auth-comingsoon-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:18:53 GMT -->
...
<body>
  ...
  <main id="comingsoon" class="empty-state empty-state-fullpage bg-primary text-white" style="background-image: url(assets/images/illustration/img-1.png);">
    ...
    <div class="empty-state-container">
      <h1 class="state-header" style="letter-spacing: 4px;"> COMING SOON </h1>
  ...
  <!-- BEGIN PLUGINS JS -->
  <script src="assets/vendor/particles.js/particles.js"></script> <!-- END PLUGINS JS -->
  <!-- BEGIN THEME JS -->
