...
<!-- Mirrored from uselooper.com/component-tasks.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:16 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Tasks | Looper - Bootstrap 4 Admin Theme </title>
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <p class="text-muted"> A tasks gives you a clear visual overview of what is being worked on and who is working on it and other information that used for project management purpose. </p>
              ...
              <div class="page-section">
                  ...
                  <div class="board">
                    ...
                    <div class="tasks">
                      ...
                      <div class="task-header">
                        <h3 class="task-title mr-auto"> Backlogs <span class="badge">(2)</span>
                        </h3>
                        <div class="dropdown">
                    ...
                    <div class="tasks">
                      <!-- .tasks-header -->
                      <div class="task-header">
                        <h3 class="task-title mr-auto"> In Progress <span class="badge">(1)</span>
                        </h3>
                        <div class="dropdown">
                          <button class="btn btn-light btn-icon"><i class="fa fa-ellipsis-v"></i></button>
                        </div>
                    ...
                    <div class="tasks">
                      <!-- .tasks-header -->
                      <div class="task-header">
                        <h3 class="task-title mr-auto"> In Review <span class="badge">(2)</span>
                        </h3>
                        <div class="dropdown">
                          <button class="btn btn-light btn-icon"><i class="fa fa-ellipsis-v"></i></button>
                        </div>
                    ...
                    <div class="tasks">
                      <!-- .tasks-header -->
                      <div class="task-header">
                        <h3 class="task-title mr-auto"> Done <span class="badge">(1)</span>
                        </h3>
                        <div class="dropdown">
                          <button class="btn btn-light btn-icon"><i class="fa fa-ellipsis-v"></i></button>
                        </div>
                ...
                <!-- .section-block -->
                <div class="section-block">
                  <h2 class="section-title"> Simple style </h2><!-- .board -->
                  <div class="board">
                    <!-- .tasks -->
                    <div class="tasks">
                      <!-- .tasks-header -->
                      <div class="task-header">
                        <h3 class="task-title mr-auto"> Backlogs <span class="badge">(5)</span>
                        </h3>
                        <div class="dropdown">
                          <button class="btn btn-light btn-icon"><i class="fa fa-ellipsis-v"></i></button>
                        </div>
                      ...
                      <div class="task-body">
                        ...
                        <div class="task-issue">
                          ...
                          <div class="card">
                            ...
                            <div class="card-body">
                              <h3 class="card-title mb-1">
                                <a href="#">Write new content</a>
                              </h3>
                              <ul class="list-inline text-muted">
                                <li class="list-inline-item">
                                  <i class="far fa-fw fa-clock"></i> In 3 days </li>
                                <li class="list-inline-item">
                                  <i class="fa fa-fw fa-tasks"></i> 6/6 </li>
                              </ul><!-- .d-flex -->
                              <div class="d-flex">
                                <!-- .avatar-group -->
                                <div class="avatar-group ml-auto">
                                  <!-- members -->
                                  <a href="#" class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Johnny Day"><img src="assets/images/avatars/uifaces2.jpg" alt="Johnny Day"></a> <!-- /members -->
                                </div><!-- /.avatar-group -->
                              </div><!-- /.d-flex -->
                            </div><!-- /.card-body -->
                          </div><!-- .card -->
                        ...
                        <div class="task-issue">
                          ...
                          <div class="card">
                            ...
                            <div class="card-body">
                              <h3 class="card-title mb-1">
                                <a href="#">Apply new styles</a>
                              </h3>
                              <ul class="list-inline text-muted">
                                <li class="list-inline-item">
                                  <i class="far fa-fw fa-clock"></i> Tomorrow </li>
                                <li class="list-inline-item">
                                  <i class="fa fa-fw fa-tasks"></i> 19/21 </li>
                              </ul><!-- .d-flex -->
                              <div class="d-flex">
                                <!-- .avatar-group -->
                                <div class="avatar-group ml-auto">
                                  <!-- members -->
                                  <a href="#" class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Johnny Day"><img src="assets/images/avatars/uifaces2.jpg" alt="Johnny Day"></a> <a href="#" class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Sarah Bishop"><img src="assets/images/avatars/uifaces3.jpg" alt="Sarah Bishop"></a> <!-- /members -->
                                </div><!-- /.avatar-group -->
                              </div><!-- /.d-flex -->
                            </div><!-- /.card-body -->
                          </div><!-- .card -->
                        ...
                        <div class="task-issue">
                          ...
                          <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <ul class="list-inline text-muted">
                                <li class="list-inline-item">
                                  <i class="far fa-fw fa-clock"></i> Apr 07 </li>
                              </ul><!-- .d-flex -->
                              <div class="d-flex">
                                <!-- .avatar-group -->
                                <div class="avatar-group ml-auto">
                    ...
                    <div class="tasks">
                      <!-- .tasks-header -->
                      <div class="task-header">
                        <h3 class="task-title mr-auto"> In Progress <span class="badge">(2)</span>
                        </h3>
                        <div class="dropdown">
                          <button class="btn btn-light btn-icon"><i class="fa fa-ellipsis-v"></i></button>
                        </div>
                    ...
                    <div class="tasks">
                      <!-- .tasks-header -->
                      <h3 class="task-title mr-auto"> In Review <span class="badge">(4)</span>
                      </h3>
                      <div class="dropdown">
                        <button class="btn btn-light btn-icon"><i class="fa fa-ellipsis-v"></i></button>
                      </div><!-- /.tasks-header -->
                    ...
                    <div class="tasks">
                      <!-- .tasks-header -->
                      <div class="task-header">
                        <h3 class="task-title mr-auto"> Done <span class="badge">(3)</span>
                        </h3>
                        <div class="dropdown">
                          <button class="btn btn-light btn-icon"><i class="fa fa-ellipsis-v"></i></button>
                        </div>
                ...
                <!-- .section-block -->
                <div class="section-block">
                  <h2 class="section-title"> List Style </h2><!-- .board -->
                  <div class="board board-list">
                    <!-- .tasks -->
                    <div class="tasks">
                      <!-- .tasks-header -->
                      <div class="task-header">
                        <h3 class="task-title mr-auto"> On Going Tasks <span class="badge">(6)</span>
                        </h3><select class="custom-select" style="width:160px">
