...
<!-- Mirrored from uselooper.com/component-general.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:10 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> General Elements | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="General Elements">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-header">
                              <h5 id="exampleModalAlertLabel" class="modal-title">
                                <i class="fa fa-trophy text-success mr-1"></i> Congrats! You Unlock New Feature. </h5>
                            </div><!-- /.modal-header -->
                            <!-- .modal-body -->
                            <div class="modal-body">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-header">
                              <h5 id="exampleModalAlertWarningLabel" class="modal-title">
                                <i class="fa fa-bullhorn text-warning mr-1"></i> Modal: warning </h5>
                            </div><!-- /.modal-header -->
                            <!-- .modal-body -->
                            <div class="modal-body">
                              <p> Eligendi rem, pariatur saepe! Sunt, nulla, esse eligendi culpa doloremque non maxime! </p>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-header">
                              <h5 id="exampleModalAlertDangerLabel" class="modal-title">
                                <i class="fa fa-exclamation-triangle text-red mr-1"></i> Alert: danger </h5>
                            </div><!-- /.modal-header -->
                            <!-- .modal-body -->
                            <div class="modal-body">
                              <p> Eligendi rem, pariatur saepe! Sunt, nulla, esse eligendi culpa doloremque non maxime! </p>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <div class="alert alert-danger alert-dismissible fade show">
                        <button type="button" class="close" data-dismiss="alert">×</button> <strong>Oh snap!</strong> <a href="#" class="alert-link">Change a few things up</a> and try submitting again. </div>
                    </div><!-- /grid column -->
                    <!-- grid column -->
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                      <div class="alert alert-info alert-dismissible fade show">
                        <button type="button" class="close" data-dismiss="alert">×</button> <strong>Heads up!</strong> This <a href="#" class="alert-link">alert needs your attention</a>, but it's not super important. </div>
                    </div><!-- /grid column -->
                    <!-- grid column -->
                    <div class="col-lg-4">
...
&lt;/html&gt;</pre>
                    ...
                    <figure>
                      <img src="../bulma.io/images/placeholders/256x256.png" alt=""> <img src="../bulma.io/images/placeholders/256x256.png" alt="">
    ...
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/toastr-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<!-- Mirrored from uselooper.com/component-general.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 06:19:11 GMT -->
</html>